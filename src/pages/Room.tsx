...
export function Room(){
    ...
    // Criando objeto pergunta 
        ...
        await database.ref(`/rooms/${roomId}/questions`).push(question); //Salvando o objeto criado question dentro da sala no firebase
        setNewQuestion(''); //Limpando o textarea após enviar a pergunta
    }
